                  ...
                  children: [
                    Expanded(
                      ...
                      child: OutlinedButton(
                        ...
                        child: const Text('Tahan (F3)', style: TextStyle(color: SolluColors.primary, fontWeight: FontWeight.bold)),
                      ),
                    ),
                    ...
                    Expanded(
                      ...
                      child: ElevatedButton(
                        ...
                        child: const Text('Bayar (F8)', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                      ),
                    ),
                  ],
                ),
